class AppointmentStep2 < ApplicationRecord
  enum status: {
    pending: 0,
    confirmed: 1,
    canceled: 2,
  ...
  has_many :appointment_alerts # different from appointment_step_1
  ...
  # Method mark_alert_sent doesn't exist here anymore
